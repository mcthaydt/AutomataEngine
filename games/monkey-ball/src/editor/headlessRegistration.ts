...
import type { GameDefinition, Surface } from '@automata/editor/headless'
...
/** Platform-neutral Monkey Ball definition for MCP and other headless consumers. */
export function createHeadlessMonkeyBallDefinition(
