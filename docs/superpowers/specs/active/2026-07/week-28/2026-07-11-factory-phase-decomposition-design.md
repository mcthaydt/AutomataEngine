...
| 4 — Capability packs | Widen the slice's pack to the initial 7 reusable packs | — (widens slice) | Phase 3 | 7 (one per pack); 3 of 7 completed (2026-07-17); cycle 4 specced + planned (2026-07-17) |
| 5 — Asset pipeline | Normalized, versioned asset manifest with providers, provenance, validation | — | Phase 3 (parallel with 4) | 4 (3 completed 2026-07-17; extension cycle 4 specced + planned 2026-07-17) |
