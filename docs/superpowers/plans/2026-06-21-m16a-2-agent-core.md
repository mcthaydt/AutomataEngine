...
- [ ] **Step 3: Create a barrel and a smoke test**
...
- [ ] **Step 4: Add the eslint dependency rule**
...
- [ ] **Step 5: Add agent-core to coverage include**
...
- [ ] **Step 6: Install workspaces so the new package + SDKs resolve**
