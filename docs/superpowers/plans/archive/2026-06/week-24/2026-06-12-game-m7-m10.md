...
**Spec:** `../../../../specs/archive/2026-06/week-24/2026-06-09-automata-engine-monkey-ball-design.md`. This plan covers milestones M7–M10 only. Plan 3 (editor/content/polish, M11–M15) is written after this plan ships.
...
- [x] **Step 3: Implement — replace `games/monkey-ball/src/state/root.ts`**
...
- [x] **Step 2: Replace `games/monkey-ball/src/main.ts`**
...
- [x] **Step 4: Verify in a real browser (manual checkpoint)**
...
- [x] **Step 3: Replace `games/monkey-ball/src/game/gameplay.ts`**
...
- [x] **Step 4: Wire audio into `main.ts`**
...
- [x] **Step 5: Run the M10 + earlier gameplay tests**

Run: `npx vitest run games/monkey-ball/tests/game/`
Expected: PASS — the M10 test plus the M7/M8 runner tests (audio is optional).

- [x] **Step 6: Verify in a real browser (manual checkpoint)**
...
- [x] **Step 1: Run the full gate + coverage**
