...
This is the second slice of M16a (after `@automata/contracts`, the [M16a-1 plan](2026-06-18-editor-mcp-tuning-m16.md)). Follow-on plans: M16a-3 editor ToolHost + chat overlay shell ([`2026-06-21-m16a-3-editor-host-chat-shell.md`](2026-06-21-m16a-3-editor-host-chat-shell.md)), M16c preview/confirm, M16b tuning loop (adds `src/tuning/*` to this same package and widens the headless input seam), M16d MCP server. Full design: [`2026-06-21-editor-mcp-tuning-design.md`](../../../../specs/archive/2026-06/week-25/2026-06-21-editor-mcp-tuning-design.md).
...
- [x] **Step 3: Implement the provider contract**
...
- [x] **Step 3: Implement the Anthropic adapter**
...
- [x] **Step 3: Implement the OpenAI adapter**
...
- [x] **Step 4: Implement the DeepSeek adapter**
